...
| 测试框架 | JUnit Platform |
| Surefire 版本 | 3.5.3 |
| 完成时间 | 2026-09-10T14:18:53+08:00 |
| 总构建耗时 | 16.505 s |
...
|---|---:|---:|---:|---:|---:|---|
| org.example.AppTest | 1 | 0 | 0 | 0 | 0.087 s | 通过 |
...
| 阶段 | 内容 |
|---|---|
| 主源码编译 | Compiling 1 source file with javac [debug release 17] to target\classes |
| 测试源码编译 | Compiling 1 source file with javac [debug release 17] to target\test-classes |
