...
| 测试完成时间 | 2026-09-11T23:57:55+08:00 |
| 测试总耗时 | 2.028 s |
| 代码审查完成时间 | 2026-09-11T23:58:24+08:00 |
| 代码审查总耗时 | 4.563 s |
...
| PMD 解析异常 | ✅ | 本次未出现 `Unsupported class file major version 70` 解析错误 |
...
|---|---:|---:|---:|---:|---:|---|
| org.example.AppTest | 1 | 0 | 0 | 0 | 0.056 s | 通过 |
...
| PMD 版本 | 未显式打印（此前为 7.17.0） |
| 执行命令 | `mvn pmd:check` |
| 执行结果 | BUILD SUCCESS |
| 完成时间 | 2026-09-11T23:58:24+08:00 |
| 总耗时 | 4.563 s |
| 违规情况 | 未报告代码违规 |
