...
class PatrolConfigTest {
    ...
    void rejectsNonFiniteOrNonPositiveFrozenParameters() {
        assertThrows(IllegalArgumentException.class, () -> new PatrolConfig(48.0, 0.0, 0.000048));
        assertThrows(IllegalArgumentException.class,
                () -> new PatrolConfig(Double.NaN, 2.0, 0.000048));
        assertThrows(IllegalArgumentException.class, () -> new PatrolConfig(48.0, 2.0, 0.0));
    }
}
