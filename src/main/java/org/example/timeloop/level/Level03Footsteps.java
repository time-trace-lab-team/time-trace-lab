...
public final class Level03Footsteps {
    ...
    private static List<PathNode> buildPathNodes(double tileSize) {
        ...
        PathNode start = new PathNode(new Vector2D(3.5 * tileSize, 13.5 * tileSize), allDirs);
        start.setDefaultExit(PathNode.Dir.UP);
        nodes.add(start);

        PathNode fork = new PathNode(new Vector2D(8.5 * tileSize, 13.5 * tileSize), allDirs);
        fork.setDefaultExit(PathNode.Dir.UP);
        nodes.add(fork);

        nodes.add(new PathNode(new Vector2D(8.5 * tileSize, 10.5 * tileSize), upDown));
        nodes.add(new PathNode(new Vector2D(8.5 * tileSize, 8.5 * tileSize), upDownLeft));
        nodes.add(new PathNode(new Vector2D(3.5 * tileSize, 8.5 * tileSize), upDown));
        nodes.add(new PathNode(new Vector2D(8.5 * tileSize, 8.5 * tileSize), upDownRight));
        nodes.add(new PathNode(new Vector2D(8.5 * tileSize, 6.5 * tileSize), upDown));

        nodes.add(new PathNode(new Vector2D(12.5 * tileSize, 13.5 * tileSize), allDirs));
        nodes.add(new PathNode(new Vector2D(12.5 * tileSize, 10.5 * tileSize), upDown));
        nodes.add(new PathNode(new Vector2D(12.5 * tileSize, 8.5 * tileSize), upDown));
        nodes.add(new PathNode(new Vector2D(12.5 * tileSize, 6.5 * tileSize), upDown));
        nodes.add(new PathNode(new Vector2D(8.5 * tileSize, 6.5 * tileSize), leftRight));

        nodes.add(new PathNode(new Vector2D(5.5 * tileSize, 5.5 * tileSize), allDirs));
        nodes.add(new PathNode(new Vector2D(5.5 * tileSize, 3.5 * tileSize), upDown));
        nodes.add(new PathNode(new Vector2D(5.5 * tileSize, 1.5 * tileSize), upDown));
